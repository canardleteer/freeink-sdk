...
8 MB PSRAM is on the silicon; the sample env leaves it **off**
(`BOARD_HAS_PSRAM` is not set). Framebuffer stays in DRAM. S3 does not
imply PSRAM is in play.

Own sample env (`sticky`). One S3 binary; not shared with X3/X4.
